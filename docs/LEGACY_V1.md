...
| Workflow builder + palette | P8.6 | 🔶 **ทำแล้ว 2026-08-15** — บันทึกลำดับขั้นแล้วรันซ้ำได้ · palette จากทูลที่ต่ออยู่จริง · **ไม่มี node canvas โดยตั้งใจ** (เหตุผลใน [driving log](DRIVING_LOG.md)) |
