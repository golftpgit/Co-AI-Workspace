...
enum IAInventory {
    ...
    static let entries: [IAEntry] = [
        ...
        IAEntry(screen: "เก็บข้อมูล", area: "โต๊ะทำงาน", subTab: "เก็บข้อมูล",
                state: .partial("ออกแบบเครื่องมือได้ครบ (ผังข้อ↔construct↔RQ · ความยินยอม · "
                                + "จริยธรรม · IOC/CVI จากผู้เชี่ยวชาญ · ประตูก่อนเก็บข้อมูล) — "
                                + "การเปิดฟอร์มให้คนอื่นกรอกคือ M16 FieldServer ซึ่งยังไม่ได้ทำ (P11.5)")),
