...
enum IAInventory {
    ...
    static let entries: [IAEntry] = [
        ...
        IAEntry(screen: "เก็บข้อมูล", area: "โต๊ะทำงาน", subTab: "เก็บข้อมูล",
                state: .partial("ออกแบบเครื่องมือ · ประตูก่อนเก็บข้อมูล · เปิดฟอร์มในวงแลนแล้ว "
                                + "คำตอบลง SQLite ของโปรเจกต์ — ยังไม่มี: กรอกต่อทีหลัง (resume token) · "
                                + "รหัสนิรนามสำหรับงานหลายรอบ · หน้าดูคำตอบในแอป (P11.7/P11.7b)")),
